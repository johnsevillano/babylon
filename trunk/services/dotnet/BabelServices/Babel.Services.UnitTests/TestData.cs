    ...
    internal class TestData
    {
        ...
        internal static MediaItem[] mediaItems = new MediaItem[] {
            new MediaItem {
                ...
                Bytes = GetResourceBytes("Babel.Services.UnitTests.media.fullcircle.mp3"),
                Owner = profiles[0]
            },
            new MediaItem {
                Name = "spoungebob",
                ...
                Bytes = TestData.GetResourceBytes("Babel.Services.UnitTests.media.spongebob.jpg"),
            ...
            new MediaItem {
                ...
                Bytes = GetResourceBytes("Babel.Services.UnitTests.media.wcf.wmv"),
                Owner = profiles[2]
            }
        };
    }
